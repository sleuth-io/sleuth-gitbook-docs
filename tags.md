...
Tag names may only consist of lowercase letters (`a-z`), numbers (`0-9`), underscores (`_`) and dashes (`-`). If you try to use any other characters, your tags will be ignored.
