...
Sleuth can automatically preview your next deploy in your project and environment by displaying a comprehensive list of resources that will be deployed to your configured code repositories. The information displayed is similar to the information displayed in a [deploy card](deploy-cards.md). 
